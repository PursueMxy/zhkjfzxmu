package com.fzzhkj.spgg.SerRec;
    ...
    private boolean iterateNodesAndHandle(AccessibilityNodeInfo nodeInfo) {
        if (nodeInfo != null) {
            ...
            if ("android.widget.Button".equals(nodeInfo.getClassName())) {
                ...
                Log.e("Buttonconect",nodeCotent);
                if ("安装".equals(nodeCotent)
                        ||"继续安装".equals(nodeCotent)
                        ||"打开".equals(nodeCotent)) {
                    ToastUtils.showToast(getApplicationContext(),nodeCotent);
                    nodeInfo.performAction(AccessibilityNodeInfo.ACTION_CLICK);
                    return true;
                }else {
                    ToastUtils.showToast(getApplicationContext(),"找不到");
                }
            }
...
//                    nodeInfos = nodeInfo1.findAccessibilityNodeInfosByText("打开");
//                }
