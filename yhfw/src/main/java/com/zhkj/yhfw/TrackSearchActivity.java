...
public class TrackSearchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String startDts = intent.getStringExtra("startDt");
        String stopDts = intent.getStringExtra("stopDt");
//         startDt=Long.parseLong(startDts);
//         stopDt=Long.parseLong(stopDts);
//        try {
//            startDt = TimeUtils.dateToStamp("201907191315");
//            stopDt=TimeUtils.dateToStamp("201907191350");
...
//        }
    ...
    private void InitUI(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tv_track_search_back).setOnClickListener(this);
                        ...
                        if (queryTerminalResponse.isSuccess()) {
                            if (queryTerminalResponse.isTerminalExist()) {
                                ...
                                QueryTrackRequest queryTrackRequest = new QueryTrackRequest(
                                        ...
                                        tid,
                                        0,     // 轨迹id，不指定，查询所有轨迹，注意分页仅在查询特定轨迹id时生效，查询所有轨迹时无法对轨迹点进行分页
                                        1565494500,
                                        1565501700,
                                        0,      // 不启用去噪
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tv_track_search_back:
                finish();
                break;
                default:
                    break;
