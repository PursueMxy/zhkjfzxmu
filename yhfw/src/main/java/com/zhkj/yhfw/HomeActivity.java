...
//        LitePal.deleteAll(LiteDataBean.class);
    ...
    private void InitUI() {
        ...
        //上传的图片
            ...
            Request request = new Request.Builder().url("http://fztestc.xmhavefun.com/api/recording/add?type=1&token=e69d4cc2-986f-4e6b-a68f-b275c458b90e").post(requestBody).build();
...
//                          spservice.orderInfo();
            ...
            case R.id.dialog_confirm_tv_confirm:
                ...
                if (DIALOG_CONFIRM_TYPE==1){
                    ...
                    OkGo.<String>get("http://fztestc.xmhavefun.com/api/order/get_trace_info")
        ...
        builder.setMessage("订单完成")
                ...
                .setNeutralButton("好的", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                         OkGo.<String>get("http://fztestc.xmhavefun.com/api/order/driver_trip_delete")
                                 .params("type", "1")
                                 .params("token", token)
                                 .execute(new StringCallback() {
                                     @Override
